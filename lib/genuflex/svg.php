 ...
 */
function genuflex_mime_types( $mimes ) {
	$mimes['svg'] = 'image/svg+xml';
	return $mimes;
}
add_filter( 'upload_mimes', 'genuflex_mime_types' );
 ...
 */
function genuflex_verify_filetype( $data, $file, $filename, $mimes ) {
...
add_filter( 'wp_check_filetype_and_ext', 'genuflex_verify_filetype', 10, 4 );
 ...
 */
function genuflex_svg_media_thumbnails( $response, $attachment, $meta ) {
...
add_filter( 'wp_prepare_attachment_for_js', 'genuflex_svg_media_thumbnails', 10, 3 );
